...
export const SponsorsContainer = () => {
  return (
    <div
			...
			<MainHeadings
				title="Wellness in Bangkok"
				subtitle="Top rated doctors and clinics"
			/>
			<Slide articles={mockArticleData} />
			<h3>Thailand’s best insurance cover</h3>
			<div style={{
				width: '100%',
  			height: '300px',
  			backgroundImage: 'linear-gradient(to bottom, rgba(0, 166, 153, 0.7), rgba(0, 166, 153, 0.3))',
				display: 'flex',
				alignItems: 'center'
			}}>
				<div style={{ paddingLeft: '40px', maxWidth: '400px' }}>
					<h2 style={{ color: 'white' }}>Get more from your health insurance.</h2>
					<button>Pick Your Personalized Plan</button>
				</div>
			</div>
		</div>
  )
...
const mockArticleData = [
  {
    ...
    title: 'Top Rated Bangkok Hospitals',
  ...
  },
  {
    id: '2',
    img: 'https://picsum.photos/335/240',
    title: 'Top Bangkok Pediatricians',
  ...
  },
  {
    id: '3',
    img: 'https://picsum.photos/335/240',
    title: 'Popular Bangkok Dentists',
    subtitle: 'Mauris tempor pharetra urna, sed finibus metus dictum duis quis quam uratelam.',
    thumbnail: '',
    publishDate: 'Feb 20',
    timeToRead: '3',
